...
int main(int argc, char *argv[])
{
    ...
    // Application name
    app.setApplicationName("Musice Player");
    app.setApplicationDisplayName("Musice Player");
    app.setOrganizationName("ph");
    app.setOrganizationDomain("ph");
    ...
    DownLoaderCtrl downDtrl;
    engine_context->setContextProperty("downDtrl", &downDtrl);
